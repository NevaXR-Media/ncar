...
object MockDeviceManager : DeviceManager {
    ...
    override fun ambientLightState(): Flow<DeviceProperty<Int>> = flow {
        while (true) {
            emit(
                createMockDeviceProperty(
                    id = NCarPropertyId.VENDOR_AMBIENT_LIGHT_READ.id,
    ...
    override fun speed(): Flow<DeviceProperty<Float?>> = flow {
        while (true) {
            emit(
                createMockDeviceProperty(
                    id = NCarPropertyId.PERF_VEHICLE_SPEED.id,
                    name = NCarPropertyId.PERF_VEHICLE_SPEED.property,
                    value = 88.8f
                )
            )
            delay(500)
    ...
    override fun gearState(sensorRate: Float): Flow<DeviceProperty<Int?>> = flow {
        while (true) {
            emit(
                createMockDeviceProperty(
                    id = 0,
                    name = NCarPropertyId.GEAR_SELECTION.property,
                    value = 3
                )
            )
            delay(500)
    ...
    override fun drivingMode(): Flow<DeviceProperty<Int?>> = flow {
        while (true) {
            emit(
                createMockDeviceProperty(
                    id = 0,
                    name = NCarPropertyId.VENDOR_DRIVE_MODE_PROPERTY.property,
                    value = 1
                )
            )
            delay(500)
    ...
    override fun evChargingRate(): Flow<DeviceProperty<Float?>> = flow {
        while (true) {
            emit(
                createMockDeviceProperty(
                    id = 0,
                    name = NCarPropertyId.EV_BATTERY_INSTANTANEOUS_CHARGE_RATE.property,
                    value = 10.5f
                )
            )
            delay(500)
    ...
    override fun hvacAcStatus(): Flow<DeviceProperty<Boolean?>> = flow {
        while (true) {
            emit(
                createMockDeviceProperty(
                    id = NCarPropertyId.HVAC_AC_ON.id,
                    name = NCarPropertyId.HVAC_AC_ON.property,
                    value = true
                )
            )
            delay(500)
    ...
    override fun formattedGearState(sensorRate: Float): Flow<List<DataPoint<String?>>> = flow {
        while (true) {
            ...
            val mockGearProperty = createMockDeviceProperty(
                id = NCarPropertyId.GEAR_SELECTION.id,
                name = NCarPropertyId.GEAR_SELECTION.property,
                value = 3
            )
    ...
    override fun formattedDrivingMode(): Flow<List<DataPoint<String?>>?> = flow {
        while (true) {
            ...
            val mockDrivingModeProperty = createMockDeviceProperty(
                id = NCarPropertyId.VENDOR_DRIVE_MODE_PROPERTY.id,
                name = NCarPropertyId.VENDOR_DRIVE_MODE_PROPERTY.property,
                value = 1
            )
    ...
    override fun formattedEvChargingRate(): Flow<List<DataPoint<Float>>> = flow {
        while (true) {
            ...
            val mockChargingProperty = createMockDeviceProperty(
                id = NCarPropertyId.EV_BATTERY_INSTANTANEOUS_CHARGE_RATE.id,
                name = NCarPropertyId.EV_BATTERY_INSTANTANEOUS_CHARGE_RATE.property,
                value = 10.5f
            )
            // Emit mock formatted data point
    ...
    override fun hvacDualStatus(): Flow<DeviceProperty<Boolean?>> = flow {
        while (true) {
            emit(
                createMockDeviceProperty(
                    id = NCarPropertyId.HVAC_DUAL_ON.id,
                    name = NCarPropertyId.HVAC_DUAL_ON.property,
                    value = true
                )
            )
            delay(500)
    ...
    override fun hvacMaxStatus(): Flow<DeviceProperty<Boolean?>> = flow {
        while (true) {
            emit(
                createMockDeviceProperty(
                    id = NCarPropertyId.HVAC_MAX_AC_ON.id,
                    name = NCarPropertyId.HVAC_MAX_AC_ON.property,
                    value = false
                )
            )
            delay(500)
    ...
    override fun hvacSpeed(): Flow<DeviceProperty<Int?>> = flow {
        while (true) {
            emit(
                createMockDeviceProperty(
                    id = NCarPropertyId.HVAC_FAN_SPEED.id,
                    name = NCarPropertyId.HVAC_FAN_SPEED.property,
                    value = 3
                )
            )
            delay(500)
    ...
    override fun hvacTemperature(): Flow<List<DeviceProperty<Float?>>> = flow {
        while (true) {
            emit(
                listOf(
                    createMockDeviceProperty(
                        id = NCarPropertyId.HVAC_TEMPERATURE_SET.id,
                        name = NCarPropertyId.HVAC_TEMPERATURE_SET.property,
                        value = 22.5f,
